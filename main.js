...
function addTaskToUl(){
    ...
    testParagrph.textContent = _sortTasksByDueDate__WEBPACK_IMPORTED_MODULE_1__.todayTasks[_sortTasksByDueDate__WEBPACK_IMPORTED_MODULE_1__.todayTasks.length - 1].title
    testLi.appendChild(testParagrph)

    const testP = document.createElement("p")
    testP.textContent = _sortTasksByDueDate__WEBPACK_IMPORTED_MODULE_1__.todayTasks[_sortTasksByDueDate__WEBPACK_IMPORTED_MODULE_1__.todayTasks.length - 1].dueDate
...
function switchTabs() {
  ...
  todayLi.addEventListener("click", () => {
   ...
   (0,_addTaskToUl__WEBPACK_IMPORTED_MODULE_5__["default"])()
  });
