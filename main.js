...
.project-btn-div .project-plus-icon {
  max-width: 10%;
  cursor: pointer;
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _eventHandler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./eventHandler */ "./src/functions/eventHandler.js");
/* harmony import */ var _assets_wrench_cog_outline_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../assets/wrench-cog-outline.svg */ "./src/assets/wrench-cog-outline.svg");
/* harmony import */ var _assets_minus_circle_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../assets/minus-circle.svg */ "./src/assets/minus-circle.svg");
...
function addProjectToUl(project, index) {
  ...
  wrenchIcon.src = _assets_wrench_cog_outline_svg__WEBPACK_IMPORTED_MODULE_1__;
  projectLi.appendChild(wrenchIcon);

  container.appendChild(projectLi);

  const deleteIcon = new Image();
  deleteIcon.src = _assets_minus_circle_svg__WEBPACK_IMPORTED_MODULE_2__;
  ...
  (0,_eventHandler__WEBPACK_IMPORTED_MODULE_0__.attachProjectNameEventListeners)();
}
...
function handleProjectNameClick(projectName) {
  const project = _addProject__WEBPACK_IMPORTED_MODULE_5__.projects.find((project) => project.name === projectName);
  if (project) {
    (0,_components_customProjectsSection_createCustomProject__WEBPACK_IMPORTED_MODULE_6__["default"])(project);
  }
}
