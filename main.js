...
/* harmony import */ var _getLocalStorage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getLocalStorage */ "./src/functions/getLocalStorage.js");
/* harmony import */ var _setLocalStorage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./setLocalStorage */ "./src/functions/setLocalStorage.js");
  ...
  addProjectToUl(project, index);
    ...
    */
    ...
    const index = projects.indexOf(newProject);
      ...
      (0,_setLocalStorage__WEBPACK_IMPORTED_MODULE_2__["default"])("projectsLocalStorage", projects);

      const storedProjects = (0,_getLocalStorage__WEBPACK_IMPORTED_MODULE_1__["default"])("projectsLocalStorage");
...
function switchTabs() {
  ...
  todayLi.addEventListener("click", () => {
    ...
    const storedTodoList = (0,_getLocalStorage__WEBPACK_IMPORTED_MODULE_11__["default"])("TodayTodoListLocalStorage");
  ...
  weekLi.addEventListener("click", () => {
    ...
    const storedTodoList = (0,_getLocalStorage__WEBPACK_IMPORTED_MODULE_11__["default"])("weekTodoListLocalStorage");
...
const storedArr = (0,_getLocalStorage__WEBPACK_IMPORTED_MODULE_1__["default"])(key);

if(!storedArr){
(0,_setLocalStorage__WEBPACK_IMPORTED_MODULE_2__["default"])(key, arr);
} else {
   ...
   ;(0,_setLocalStorage__WEBPACK_IMPORTED_MODULE_2__["default"])(key, uniqueMerged);
}
...
function updateLocalStorage(key, taskArray) {
  ...
  (0,_setLocalStorage__WEBPACK_IMPORTED_MODULE_2__["default"])(key, taskArray);
}
