...
.add-project-form .project-flex-container .project-form-btn {
  ...
  font-weight: 700;
  cursor: pointer;
}`, "",{"version":3,"sources":["webpack://./src/components/addProjectForm/style.scss"],"names":[],"mappings":"AAKA;EACI,WAAA;AAJJ;AAMA;EACC,aAAA;EACA,yBATc;EAUd,YAAA;EACA,eAAA;EACA,8BAAA;EACA,sBAAA;EACA,0BAAA;AAJD;AAMC;EACG,cAAA;AAJJ;AAQA;EACI,aAAA;EACA,sBAAA;EACA,4BAAA;AANJ;AAQI;EACE,YAAA;EACA,yBA5BS;EA6BT,kBAAA;EACA,YAAA;EACA,gBAAA;EACA,iBAAA;EACA,gBAAA;EACA,eAAA;AANN","sourcesContent":["$text-color: #757575;\n$header-color: #3498db;\n$bg-color: #ffffff;\n\n\n.add-project-form{\n    width: 100%;\n\n.project-form-header{\n display: flex;\n background-color: $header-color;\n color: white;\n font-size: 1rem;\n justify-content: space-between;\n padding: 0 1rem 0 1rem;\n border-radius: 5px 5px 0 0;\n\n .project-form-img{\n    max-width: 10%;\n }\n}\n\n.project-flex-container {\n    display: flex;\n    flex-direction: column;\n    padding: 2rem 4rem 2rem 4rem;\n\n    .project-form-btn {\n      color: white;\n      background-color: $header-color;\n      border-radius: 5px;\n      border: none;\n      margin-top: 2rem;\n      padding: 0.5rem 0;\n      font-weight: 700;\n      cursor: pointer;\n    }\n}\n}"],"sourceRoot":""}]);
// Exports
...
.delete-modal .delete-modal-buttons .modal-delete-btn {
  ...
  padding: 0.4em 2em;
  cursor: pointer;
}`, "",{"version":3,"sources":["webpack://./src/components/deleteModal/style.scss"],"names":[],"mappings":"AAIA;EACE,kBAAA;AAHF;;AAMA;EACE,WAAA;EACA,kBAAA;EACA,QAAA;EACA,SAAA;EACA,gCAAA;EACA,kBAAA;EACA,4CAAA;EACA,eAAA;EACA,yBAfS;AAYX;AAIE;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,oBAAA;EACA,yBAvBW;EAwBX,iBAAA;EACA,YAAA;AAFJ;AAGI;EACE,cAAA;AADN;AAKE;EACE,cA/BS;EAgCT,4BAAA;AAHJ;AAME;EACE,aAAA;EACA,yBAAA;EACA,kBAAA;EACA,WAAA;AAJJ;AAKI;EACE,oBAAA;EACA,kBAAA;EACA,YAAA;EACA,eAAA;EACA,cA7CO;AA0Cb;AAKI;EACE,qBAAA;EACA,YAAA;EACA,YAAA;EACA,kBAAA;EACA,kBAAA;EACA,eAAA;AAHN","sourcesContent":["$header-color: #3498db;\n$text-color: #757575;\n$bg-color: #ffffff;\n\n#content {\n  position: relative;\n}\n\n.delete-modal {\n  width: 100%;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  border-radius: 5px;\n  box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;\n  font-size: 1rem;\n  background-color: $bg-color;\n  .delete-modal-header {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    padding: 0 2em 0 2em;\n    background-color: $header-color;\n    font-size: 0.8rem;\n    color: white;\n    .alert-icon {\n      max-width: 15%;\n    }\n  }\n\n  .delete-modal-warning {\n    color: $text-color;\n    padding: 2rem 2rem 2rem 2rem;\n  }\n\n  .delete-modal-buttons {\n    display: flex;\n    justify-content: flex-end;\n    padding: 0 2em 0 0;\n    gap: 0.3rem;\n    .cancel-btn {\n      padding: 0.4em 0.4em;\n      border-radius: 5px;\n      border: none;\n      cursor: pointer;\n      color: $text-color;\n    }\n    .modal-delete-btn {\n      background-color: red;\n      color: white;\n      border: none;\n      border-radius: 5px;\n      padding: 0.4em 2em;\n      cursor: pointer;\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
function toggleNav(){
    ...
    hamburger.addEventListener("click", ()=>{
        if(isNavOpen){
            ...
            (0,_switchTabs__WEBPACK_IMPORTED_MODULE_2__["default"])();
...
/* harmony import */ var _components_editFileForm_editFileForm__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components/editFileForm/editFileForm */ "./src/components/editFileForm/editFileForm.js");
