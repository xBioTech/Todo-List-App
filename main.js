...
.task-ul .task-li p {
  display: flex;
  align-items: center;
}`, "",{"version":3,"sources":["webpack://./src/style.scss"],"names":[],"mappings":"AAQA;EACE,sBAAA;EACA,SAAA;EACA,UAAA;AAPF;;AAUA;EACE,yBAfS;AAQX;;AAWE;EACE,aAAA;EACA,kCAAA;EACA,uBAAA;EACA,SAAA;AARJ;AASI;EACE,oBAAA;EACA,kBAAA;EACA,eAAA;AAPN;AAUI;EACE,aAAA;EACA,mBAAA;AARN","sourcesContent":["$bg-color: #ffffff;\n$header-color: #3498db;\n$accent-color: #2ecc71;\n$main-content-text: #333333;\n$completed-task: #555555;\n$urgent-task: #e74c3c;\n$text-color: #757575;\n\n* {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0;\n}\n\nbody {\n  background-color: $bg-color;\n}\n\n.task-ul {\n  .task-li {\n    display: grid;\n    grid-template-columns: 1fr 1fr 1fr;\n    grid-template-rows: 1fr;\n    gap: 2rem;\n    p:first-child {\n      grid-column-start: 1;\n      grid-column-end: 2;\n      max-width: 70px;\n    }\n\n    p {\n      display: flex;\n      align-items: center;\n    }\n\n    button {\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _functions_firstPageLoad__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./functions/firstPageLoad */ "./src/functions/firstPageLoad.js");
/* harmony import */ var _functions_switchTabs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./functions/switchTabs */ "./src/functions/switchTabs.js");
/* harmony import */ var _functions_toggleNav__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./functions/toggleNav */ "./src/functions/toggleNav.js");
