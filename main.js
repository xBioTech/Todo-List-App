...
function attachEventListenersForInfoButton() {
  ...
  mainContent.addEventListener("click", (event) => {
    if (event.target.classList.contains("info-btn")) {
      const dataIndex = event.target.closest("li").getAttribute("data-index");
      const clickedTask = _sortTasksByDueDate__WEBPACK_IMPORTED_MODULE_3__.todayTasks[dataIndex];
...
function switchTabs() {
  ...
  todayLi.addEventListener("click", () => {
    ...
    (0,_eventHandler__WEBPACK_IMPORTED_MODULE_4__.renderDeleteModal)();
    (0,_eventHandler__WEBPACK_IMPORTED_MODULE_4__.attachEventListenersForInfoButton)();
    (0,_sortTasksByDueDate__WEBPACK_IMPORTED_MODULE_6__.sortTasks)();
...
/* harmony import */ var _functions_firstPageLoad__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./functions/firstPageLoad */ "./src/functions/firstPageLoad.js");
/* harmony import */ var _functions_switchTabs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./functions/switchTabs */ "./src/functions/switchTabs.js");
/* harmony import */ var _functions_toggleNav__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./functions/toggleNav */ "./src/functions/toggleNav.js");
