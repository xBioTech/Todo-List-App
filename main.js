...
function sortTasks(arr) {
  ...
  const storedFormattedList = (0,_getLocalStorage__WEBPACK_IMPORTED_MODULE_2__["default"])("formattedTodoListLocalStorage"); 
  const storedTodayList = (0,_getLocalStorage__WEBPACK_IMPORTED_MODULE_2__["default"])("TodayTodoListLocalStorage");
  const storedWeekList = (0,_getLocalStorage__WEBPACK_IMPORTED_MODULE_2__["default"])("weekTodoListLocalStorage");
...
*/
  ...
  if (!storedFormattedList) {
    (0,_setLocalStorage__WEBPACK_IMPORTED_MODULE_1__["default"])("formattedTodoListLocalStorage", formattedTodoList);
  }  else {
    ...
    (0,_setLocalStorage__WEBPACK_IMPORTED_MODULE_1__["default"])("formattedTodoListLocalStorage", uniqueMergedArray);
  }

  if (!storedTodayList) {
    (0,_setLocalStorage__WEBPACK_IMPORTED_MODULE_1__["default"])("TodayTodoListLocalStorage", todayTasks);
  }

  if (!storedWeekList) {
    (0,_setLocalStorage__WEBPACK_IMPORTED_MODULE_1__["default"])("weekTodoListLocalStorage", weekTasks);
  }
