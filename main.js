...
.add-project-form .project-flex-container .project-form-btn:hover {
  ...
  background-color: #3498db;
  color: white;
}`, "",{"version":3,"sources":["webpack://./src/components/addProjectForm/style.scss"],"names":[],"mappings":"AAKA;EACI,WAAA;AAJJ;AAMA;EACC,aAAA;EACA,yBATc;EAUd,YAAA;EACA,eAAA;EACA,8BAAA;EACA,sBAAA;EACA,0BAAA;AAJD;AAKC;EACG,cAAA;AAHJ;AAOA;EACI,aAAA;EACA,sBAAA;EACA,4BAAA;AALJ;AAOI;EACE,cA3BO;EA4BP,kBAAA;EACA,yBAAA;EACA,gBAAA;EACA,iBAAA;EACA,gBAAA;EACA,eAAA;EACA,gCAAA;AALN;AAMM;EACE,yBAAA;EACA,yBApCO;EAqCP,YAAA;AAJR","sourcesContent":["$text-color: #757575;\n$header-color: #3498db;\n$bg-color: #ffffff;\n\n\n.add-project-form{\n    width: 100%;\n\n.project-form-header{\n display: flex;\n background-color: $header-color;\n color: white;\n font-size: 1rem;\n justify-content: space-between;\n padding: 0 1rem 0 1rem;\n border-radius: 5px 5px 0 0;\n .project-form-img{\n    max-width: 10%;\n }\n}\n\n.project-flex-container {\n    display: flex;\n    flex-direction: column;\n    padding: 2rem 4rem 2rem 4rem;\n\n    .project-form-btn {\n      color: $text-color;\n      border-radius: 5px;\n      border: 1px solid $text-color;\n      margin-top: 2rem;\n      padding: 0.5rem 0;\n      font-weight: 700;\n      cursor: pointer;\n      transition: all 0.2s ease-in-out;\n      &:hover{\n        border: 1px solid $header-color;\n        background-color: $header-color;\n        color: white;\n      }\n    }\n}\n}"],"sourceRoot":""}]);
// Exports
...
.delete-modal .delete-modal-buttons .modal-delete-btn:hover {
  ...
  color: white;
}`, "",{"version":3,"sources":["webpack://./src/components/deleteModal/style.scss"],"names":[],"mappings":"AAIA;EACE,kBAAA;AAHF;;AAMA;EACE,WAAA;EACA,kBAAA;EACA,QAAA;EACA,SAAA;EACA,gCAAA;EACA,kBAAA;EACA,4CAAA;EACA,eAAA;EACA,yBAfS;AAYX;AAIE;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,oBAAA;EACA,yBAvBW;EAwBX,iBAAA;EACA,YAAA;AAFJ;AAGI;EACE,cAAA;AADN;AAKE;EACE,cA/BS;EAgCT,4BAAA;AAHJ;AAME;EACE,aAAA;EACA,yBAAA;EACA,kBAAA;EACA,WAAA;AAJJ;AAKI;EACE,oBAAA;EACA,kBAAA;EACA,yBAAA;EACA,eAAA;EACA,cA7CO;EA8CP,gCAAA;AAHN;AAKI;EACE,cAjDO;EAkDP,yBAAA;EACA,kBAAA;EACA,kBAAA;EACA,eAAA;EACA,gCAAA;AAHN;AAIM;EACE,qBAAA;EACA,qBAAA;EACA,YAAA;AAFR","sourcesContent":["$header-color: #3498db;\n$text-color: #757575;\n$bg-color: #ffffff;\n\n#content {\n  position: relative;\n}\n\n.delete-modal {\n  width: 100%;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  border-radius: 5px;\n  box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;\n  font-size: 1rem;\n  background-color: $bg-color;\n  .delete-modal-header {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    padding: 0 2em 0 2em;\n    background-color: $header-color;\n    font-size: 0.8rem;\n    color: white;\n    .alert-icon {\n      max-width: 15%;\n    }\n  }\n\n  .delete-modal-warning {\n    color: $text-color;\n    padding: 2rem 2rem 2rem 2rem;\n  }\n\n  .delete-modal-buttons {\n    display: flex;\n    justify-content: flex-end;\n    padding: 0 2em 0 0;\n    gap: 0.3rem;\n    .cancel-btn {\n      padding: 0.4em 0.4em;\n      border-radius: 5px;\n      border: 1px solid $text-color;\n      cursor: pointer;\n      color: $text-color;\n      transition: all 0.2s ease-in-out;\n    }\n    .modal-delete-btn {\n      color: $text-color;\n      border: 1px solid $text-color;\n      border-radius: 5px;\n      padding: 0.4em 2em;\n      cursor: pointer;\n      transition: all 0.2s ease-in-out;\n      &:hover{\n        border: 1px solid red;\n        background-color: red;\n        color: white;\n      }\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.form-footer-div {
  display: flex;
  justify-content: flex-end;
}
...
.form-footer-div .submit-changes-btn:hover {
  ...
  color: white;
  border: 1px solid #3498db;
}`, "",{"version":3,"sources":["webpack://./src/components/editFileForm/style.scss"],"names":[],"mappings":"AAIA;EACI,aAAA;EACA,yBAAA;AAHJ;AAII;EACE,gCAAA;EACA,oBAAA;EACA,kBAAA;EACA,yBAAA;EACA,eAAA;EACA,cAZO;AAUb;AAGM;EACE,qBAAA;EACA,YAAA;EACA,qBAAA;AADR;AAKI;EACE,yBAAA;EACA,cAtBO;EAuBP,kBAAA;EACA,kBAAA;EACA,eAAA;EACA,gCAAA;AAHN;AAIM;EACE,yBA7BO;EA8BP,YAAA;EACA,yBAAA;AAFR","sourcesContent":["$header-color: #3498db;\n$text-color: #757575;\n$bg-color: #ffffff;\n\n.form-footer-div{\n    display: flex;\n    justify-content: flex-end;\n    .cancel-changes-btn{\n      transition: all 0.2s ease-in-out;\n      padding: 0.4em 0.4em;\n      border-radius: 5px;\n      border: 1px solid $text-color;\n      cursor: pointer;\n      color: $text-color;\n      &:hover{\n        background-color: red;\n        color: white;\n        border: 1px solid red;\n      }\n    }\n\n    .submit-changes-btn{\n      border: 1px solid $text-color;\n      color: $text-color;\n      border-radius: 5px;\n      padding: 0.4em 2em;\n      cursor: pointer;\n      transition: all 0.2s ease-in-out;\n      &:hover{\n        background-color: $header-color;\n        color: white;\n        border: 1px solid $header-color;\n      }\n    }\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
.nav ul li .calendar-icon {
  max-width: 30%;
}`, "",{"version":3,"sources":["webpack://./src/components/nav/style.scss"],"names":[],"mappings":"AAMA;EACE,aAAA;EACA,sBAAA;EACA,SAAA;EACA,yBARe;EASf,cARW;EASX,4BAAA;EACA,sBAAA;AALF;AAOE;EACE,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,gCAAA;EACA,kBAAA;AALJ;AAOI;EACE,cAAA;AALN;AASE;EACE,aAAA;EACA,mBAAA;EACA,mBAAA;EACA,qBAAA;AAPJ;AAQI;EACE,cAAA;EACA,eAAA;AANN;AAUE;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;AARJ;AAYE;EACE,aAAA;EACA,8BAAA;AAVJ;AAaE;EACE,eAAA;EACA,eAAA;EACA,kBAAA;AAXJ;AAaI;EACF,8BAAA;EACA,YAAA;EACA,cAAA;EACA,gBAAA;AAXF;AAYM;EACE,cAAA;AAVR;AAgBE;EACE,gCAAA;EACA,sBAAA;AAdJ;AAgBE;EACE,iBAAA;EACA,kBAAA;AAdJ;AAgBE;EACE,gBAAA;EACA,iBAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,SAAA;AAdJ;AAgBI;EACE,aAAA;EACA,8BAAA;AAdN;AAiBI;EACE,aAAA;EACA,8BAAA;AAfN;AAiBI;EACE,aAAA;EACA,2BAAA;EACA,mBAAA;EACA,uBAAA;EACA,SAAA;EACA,YAAA;EACA,kBAAA;EACA,eAAA;EACA,oBAAA;EACA,qBAAA;EACA,uBAAA;AAfN;AAgBM;EACE,YAAA;EACA,yBAtGM;AAwFd;AAgBM;EACE,cAAA;AAdR","sourcesContent":["$completed-task: #555555;\n\n$nav-background: #f7f7f7;\n$text-color: #757575;\n$hover-state: #3498db;\n\n.nav {\n  display: flex;\n  flex-direction: column;\n  gap: 2rem;\n  background-color: $nav-background;\n  color: $text-color;\n  border-radius: 0 0 10px 10px;\n  padding-bottom: 1.2rem;\n\n  .home-li {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    padding: 0.5rem 6rem 0.5rem 6rem;\n    margin-top: 1.4rem;\n\n    .home-icon {\n      max-width: 60%;\n    }\n  }\n\n  .project-container {\n    display: flex;\n    flex-direction: row;\n    align-items: center;\n    margin-bottom: 1.2rem;\n    img {\n      max-width: 10%;\n      cursor: pointer;\n    }\n  }\n\n  .nav-div-bottom {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n\n .projects-ul{\n\n  .project{\n    display: flex;\n    justify-content: space-between;\n  }\n\n  .delete-project-btn{\n    max-width: 8.5%;\n    cursor: pointer;\n    margin-left: .5em;\n  }\n    .custom-project{\n  justify-content: space-between;\n  padding: 5px; \n  overflow: auto;\n  margin-left: 3em;\n      img{\n        max-width: 15%;\n      }\n    }\n  }\n}\n\n  .project-headline {\n    border-bottom: solid 3px $text-color;\n    padding: 0 6rem 0 6rem;\n  }\n  h3 {\n    font-size: 1.3rem;\n    text-align: center;\n  }\n  ul {\n    list-style: none;\n    font-size: 1.2rem;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    gap: 1rem;\n\n    .all-li {\n      display: flex;\n      justify-content: space-between;\n    }\n\n    .today-li {\n      display: flex;\n      justify-content: space-between;\n    }\n    li {\n      display: flex;\n      flex-direction: row-reverse;\n      align-items: center;\n      justify-content: center;\n      gap: 2rem;\n      width: 250px;\n      text-align: center;\n      cursor: pointer;\n      padding: 0.5rem 4rem;\n      border-radius: 0.4rem;\n      background-color: white;\n      &:hover {\n        color: white;\n        background-color: $hover-state;\n      }\n      .calendar-icon {\n        max-width: 30%;\n      }\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
function editFile(taskArray, index){
   ...
   if(formTitleValue === ""){
      ...
      if(currentTab === "all"){
         (0,_sortTasksByDueDate__WEBPACK_IMPORTED_MODULE_5__.sortTasks)();
...
function attachEventListenersForCustomProjectsAddTaskForm(uniqueArr) {
  ...
  mainContent.addEventListener("click", (event)=>{
    if(event.target.classList.contains("project-add-task-icon")){
      ...
      submitBtn.addEventListener("click", (e)=>{
        e.preventDefault();
        (0,_addTask__WEBPACK_IMPORTED_MODULE_2__.addTaskToTodoListArray)(uniqueArr);
...
function sortTasks() {
  _addTask__WEBPACK_IMPORTED_MODULE_0__.todoList.sort((a, b) => a.dueDate - b.dueDate);
  ...
  formattedTodoList = _addTask__WEBPACK_IMPORTED_MODULE_0__.todoList.map((task) => ({
    ...task,
  ...
  todayTasks = _addTask__WEBPACK_IMPORTED_MODULE_0__.todoList
    .filter((task) => (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(task.dueDate, currentDate))
    .map((task) => ({
      ...task,
      dueDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.dueDate, "dd/MM/yyyy"),
    }));
  weekTasks = _addTask__WEBPACK_IMPORTED_MODULE_0__.todoList
...
function switchTabs() {
  ...
  allLi.addEventListener("click", () => {
    ...
    (0,_sortTasksByDueDate__WEBPACK_IMPORTED_MODULE_6__.sortTasks)();
...
/* harmony import */ var _functions_firstPageLoad__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./functions/firstPageLoad */ "./src/functions/firstPageLoad.js");
/* harmony import */ var _functions_switchTabs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./functions/switchTabs */ "./src/functions/switchTabs.js");
/* harmony import */ var _functions_toggleNav__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./functions/toggleNav */ "./src/functions/toggleNav.js");
/* harmony import */ var _functions_eventHandler__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./functions/eventHandler */ "./src/functions/eventHandler.js");
