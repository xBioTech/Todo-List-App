...
.all-tasks-div {
  ...
  max-width: 70%;
  margin: 2rem 0 0 0;
}`, "",{"version":3,"sources":["webpack://./src/components/allSection/style.scss"],"names":[],"mappings":"AAEA;EACE,aAAA;EACA,2BAAA;EACA,uBAAA;EACA,kBAAA;AADF;AAGE;EACE,eAAA;EACA,gBAAA;AADJ;AAIE;EACE,cAAA;AAFJ;;AAMA;EACE,aAAA;EACA,uBAAA;EACA,gCAAA;EACA,cAAA;EACA,kBAAA;AAHF","sourcesContent":["$text-color: #757575;\n\n.headline-container-all {\n  display: flex;\n  flex-direction: row-reverse;\n  justify-content: center;\n  margin-top: 1.5rem;\n\n  .all-tasks-headline {\n    font-size: 2rem;\n    font-weight: 700;\n  }\n\n  .all-tasks-main-icon {\n    max-width: 40%;\n  }\n}\n\n.all-tasks-div {\n  display: flex;\n  justify-content: center;\n  border-bottom: 1px solid $text-color;\n  max-width: 70%;\n  margin: 2rem 0 0 0;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _components_allSection_all__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/allSection/all */ "./src/components/allSection/all.js");
/* harmony import */ var _components_homeSection_home__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/homeSection/home */ "./src/components/homeSection/home.js");
/* harmony import */ var _components_todaySection_today__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/todaySection/today */ "./src/components/todaySection/today.js");
/* harmony import */ var _components_weekSection_thisWeek__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/weekSection/thisWeek */ "./src/components/weekSection/thisWeek.js");
/* harmony import */ var _addTask__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./addTask */ "./src/functions/addTask.js");
/* harmony import */ var _switchTabs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./switchTabs */ "./src/functions/switchTabs.js");
/* harmony import */ var _clearContent__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./clearContent */ "./src/functions/clearContent.js");
/* harmony import */ var _sortTasksByDueDate__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./sortTasksByDueDate */ "./src/functions/sortTasksByDueDate.js");
/* harmony import */ var _addTaskToUl__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./addTaskToUl */ "./src/functions/addTaskToUl.js");
/* harmony import */ var _eventHandler__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./eventHandler */ "./src/functions/eventHandler.js");
...
function editFile(taskArray, index){
   ...
   if(formTitleValue === ""){
      ...
      const editedTask = new _addTask__WEBPACK_IMPORTED_MODULE_4__.Task(formTitleValue, formDescriptionValue, formDuedateValue, formPriorityValue);

      taskArray.splice(index, 1, editedTask);


      if(_switchTabs__WEBPACK_IMPORTED_MODULE_5__.currentTab === "all"){
         (0,_sortTasksByDueDate__WEBPACK_IMPORTED_MODULE_7__.sortTasks)();
         (0,_clearContent__WEBPACK_IMPORTED_MODULE_6__.clearMainContent)();
         (0,_eventHandler__WEBPACK_IMPORTED_MODULE_9__.renderDeleteModal)();
         (0,_eventHandler__WEBPACK_IMPORTED_MODULE_9__.attachEventListenersForInfoButton)(_sortTasksByDueDate__WEBPACK_IMPORTED_MODULE_7__.formattedTodoList);
         (0,_eventHandler__WEBPACK_IMPORTED_MODULE_9__.attachEventListenersForEditButton)();
         _sortTasksByDueDate__WEBPACK_IMPORTED_MODULE_7__.formattedTodoList.forEach((task, index) => {
            (0,_addTaskToUl__WEBPACK_IMPORTED_MODULE_8__.addTaskToUl)(task, index);
          });
      } else if (_switchTabs__WEBPACK_IMPORTED_MODULE_5__.currentTab === "today"){
         (0,_sortTasksByDueDate__WEBPACK_IMPORTED_MODULE_7__.sortTasks)();
         (0,_clearContent__WEBPACK_IMPORTED_MODULE_6__.clearMainContent)();
         (0,_components_todaySection_today__WEBPACK_IMPORTED_MODULE_2__["default"])();
         (0,_eventHandler__WEBPACK_IMPORTED_MODULE_9__.renderDeleteModal)();
         (0,_eventHandler__WEBPACK_IMPORTED_MODULE_9__.attachEventListenersForInfoButton)(_sortTasksByDueDate__WEBPACK_IMPORTED_MODULE_7__.todayTasks);
         (0,_eventHandler__WEBPACK_IMPORTED_MODULE_9__.attachEventListenersForEditButton)();
         _sortTasksByDueDate__WEBPACK_IMPORTED_MODULE_7__.todayTasks.forEach((task, index) => {
            (0,_addTaskToUl__WEBPACK_IMPORTED_MODULE_8__.addTaskToUl)(task, index);
          });
      } else if(_switchTabs__WEBPACK_IMPORTED_MODULE_5__.currentTab === "week"){
         (0,_sortTasksByDueDate__WEBPACK_IMPORTED_MODULE_7__.sortTasks)();
         (0,_clearContent__WEBPACK_IMPORTED_MODULE_6__.clearMainContent)();
         (0,_components_weekSection_thisWeek__WEBPACK_IMPORTED_MODULE_3__["default"])();
         (0,_eventHandler__WEBPACK_IMPORTED_MODULE_9__.renderDeleteModal)();
         (0,_eventHandler__WEBPACK_IMPORTED_MODULE_9__.attachEventListenersForInfoButton)(_sortTasksByDueDate__WEBPACK_IMPORTED_MODULE_7__.weekTasks);
         (0,_eventHandler__WEBPACK_IMPORTED_MODULE_9__.attachEventListenersForEditButton)();
         _sortTasksByDueDate__WEBPACK_IMPORTED_MODULE_7__.weekTasks.forEach((task, index) => {
            (0,_addTaskToUl__WEBPACK_IMPORTED_MODULE_8__.addTaskToUl)(task, index);
          });
      }
