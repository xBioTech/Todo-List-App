...
function renderDeleteModal() {
  ...
  mainContent.addEventListener("click", (event) => {
    if (event.target.classList.contains("delete-btn")) {
      (0,_components_deleteModal_deleteModal__WEBPACK_IMPORTED_MODULE_7__["default"])();
    }
